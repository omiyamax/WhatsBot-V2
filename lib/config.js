...
const image = {
  url: {
    D_E_DPC:
      "https://github.com/queenloramd/queen-lora-md/blob/master/GojoMedia/gojo.jpg",
    D_E_TMB:
      "https://github.com/queenloramd/queen-lora-md/blob/master/GojoMedia/gojo.jpg",
    D_E_DP_:
      "https://github.com/queenloramd/queen-lora-md/blob/master/GojoMedia/gojo.jpg",
...
const exif = {
  footer: "© 𝚀𝚄𝙴𝙴𝙽 𝙻𝙾𝚁𝙰 𝙼𝙳",
  packname: "Queen Lora Md",
  name: myconfig.profile.botName || "Queen Lora Md",
  author: myconfig.profile.ownerName || "Omindu Anjane",
  owner: myconfig.profile.ownerNumb ? ["94760510568"].push(myconfig.profile.ownerNumb) : ["94761539856"],
  cap: "*Cerated by Queen Lora Md*",
  web: "https://ominduanjane.github.io",
  github: "https://github.com/OminduAnjane",
  sc: "https://github.com/OminduAnjane/md-qr-bot.git",
  YT: "https://www.youtube.com/channel/slomindutech",
};
const quoted = {
  image: {
